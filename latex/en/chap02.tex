...
Having shown that H-Cones are V-Cones, we complete the proof of the {\MWT} for cones is complete.
...
\begin{proof}
	...
	Note that
	\[\set{\x\st\big[-\b|A\big]\onex\leq\0} = \set{\xx\st\big[-\b|A\big]\xx\leq\0} \cap \hpxz \]
	It follows that
...
\begin{Prop}[V-Cone $\to$ V-Polyhedron]
