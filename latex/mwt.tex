...
\lstinputlisting[firstline=19, firstnumber=19, lastline=22]{../cpp/include/common.h} 
...
\lstinputlisting[firstline=24, firstnumber=24, lastline=32]{../cpp/include/common.h} 
...
\lstinputlisting[firstline=12, firstnumber=12, lastline=19]{../cpp/src/fourier_motzkin.cpp} 
\lstinline{project_matrix} is used to take only only the first \lstinline{d} entries of each vector in the \lstinline{Matrix}.

\lstinputlisting[firstline=22, firstnumber=22, lastline=39]{../cpp/src/fourier_motzkin.cpp} 
...
\lstinputlisting[firstline=30, firstnumber=30, lastline=30]{../cpp/src/fourier_motzkin.cpp}
