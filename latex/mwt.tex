...
\lstinputlisting[firstline=9, firstnumber=9, lastline=10]{../cpp/include/common.h} 
...
\lstinputlisting[firstline=12, firstnumber=12, lastline=15]{../cpp/include/common.h} 
Because a V-Polyhedron needs two matrices two represent it, a the simple struct \lstinline{VPoly} is defined.

\lstinputlisting[firstline=19, firstnumber=19, lastline=19]{../cpp/include/common.h} 
...
\lstinputlisting[firstline=21, firstnumber=21, lastline=27]{../cpp/include/common.h} 
...
\lstinputlisting[firstline=38, firstnumber=38, lastline=38]{../cpp/include/common.h} 
Outputs the usage message above.

\lstinputlisting[firstline=129, firstnumber=129, lastline=131]{../cpp/src/common.cpp} 
\lstinline{check_empty_matrix} checks for the corner case of \lstinline{Matrix} operations.

\lstinputlisting[firstline=156, firstnumber=156, lastline=163]{../cpp/src/common.cpp} 
\lstinline{project_matrix} is used to take only only the first \lstinline{d} entries of each vector in the \lstinline{Matrix}.

\lstinputlisting[firstline=166, firstnumber=166, lastline=183]{../cpp/src/common.cpp} 
...
\lstinputlisting[firstline=30, firstnumber=30, lastline=30]{../cpp/src/common.cpp}
